...
> [This is an example of a simple script that used the concept of positional parameters and the associated variables.](http://steve-parker.org/sh/eg/var3.sh.txt). Try writing this script and running it to get a better idea of how these variables are assigned and to bettter understand the concet of "positional parameters".
